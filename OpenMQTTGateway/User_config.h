...
#define version_Topic "kucaRF/" Gateway_Name "/version"
#define will_Topic "kucaRF/" Gateway_Name "/LWT"
#define will_QoS 0
...
// Update these with values suitable for your network.
  ...
  #define wifi_password "OpenHAB12"
#else // for arduino + W5100
  const byte mac[] = {  0xDE, 0xED, 0xBA, 0xFE, 0x54, 0x95 }; //W5100 ethernet shield mac adress
#endif

const byte ip[] = { 192, 168, 1, 125 }; //ip adress
...
#define led_receive 5    // 40
#define led_send    6    // 42
#define led_error   7    // 44
...
#define subjectMQTTtoX "kucaRF/commands/#"
